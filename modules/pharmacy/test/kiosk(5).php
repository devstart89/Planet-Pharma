...
$queueDisplayUrl = withBranch('../public/queue_display.php', $branchSlug);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="branch-tag"><i class="bi bi-geo-alt-fill"></i> <?= htmlspecialchars($pharmacy['pharmacy_name']) ?>

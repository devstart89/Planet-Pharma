...
if (!$pharmacy) {
    renderBranchPicker($conn, 'kios.php');
}
    ...
    <div class="content-panel">
        ...
        <?php if ($isLandingState): ?>
            ...
            <div id="landingOptions" style="display:none;">
                ...
                <div class="d-grid gap-3 w-100">
                    <a href="<?= htmlspecialchars(withBranch('kios.php?mode=walkin', $branchSlug)) ?>" class="kiosk-option">
                    ...
                    <a href="<?= htmlspecialchars(withBranch('kios.php?mode=epres', $branchSlug)) ?>" class="kiosk-option">
        ...
        <?php elseif ($slip): ?>
            ...
            <div class="d-grid gap-2 mt-3 w-100" id="ticketActions" style="display:none;">
                ...
                <a href="<?= htmlspecialchars(withBranch('kios.php', $branchSlug)) ?>" class="btn btn-outline-secondary">Done</a>
            ...
            <script>
                ...
                (function () {
                    ...
                    var homeUrl = <?= json_encode(withBranch('kios.php', $branchSlug), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>;
        ...
        <?php elseif ($showCategoryStep): ?>
            ...
            <form method="post" action="<?= htmlspecialchars(withBranch('kios.php?mode=epres', $branchSlug)) ?>" class="w-100">
                ...
                <a href="<?= htmlspecialchars(withBranch('kios.php?mode=epres', $branchSlug)) ?>" class="btn btn-kiosk-link btn-sm">Start Over</a>
            </form>
        ...
        <?php elseif ($mode === 'epres'): ?>
            ...
            <form method="post" action="<?= htmlspecialchars(withBranch('kios.php?mode=epres', $branchSlug)) ?>" class="d-grid gap-2 w-100">
                ...
                <a href="<?= htmlspecialchars(withBranch('kios.php', $branchSlug)) ?>" class="btn btn-kiosk-link btn-sm">Back</a>
            </form>

        <?php elseif ($mode === 'walkin'): ?>
            <h4 class="option-heading">Please select your <span class="accent">queuing</span> option.</h4>
            <?php if ($error): ?><div class="alert alert-danger py-2 w-100"><?= htmlspecialchars($error) ?></div><?php endif; ?>
            <form method="post" action="<?= htmlspecialchars(withBranch('kios.php?mode=walkin', $branchSlug)) ?>" class="w-100">
                ...
                <a href="<?= htmlspecialchars(withBranch('kios.php', $branchSlug)) ?>" class="btn btn-kiosk-link btn-sm mt-3">Back</a>
            </form>

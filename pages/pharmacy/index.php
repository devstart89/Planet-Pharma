    ...
    <div class="services-grid">
      <div class="row g-4">
        ...
        <!-- Queueing List -->
          ...
          <!--      </div>-->
          <!--      <span class="service-category">Queueing</span>-->
          <!--    </div>-->
          <!--    <div class="service-body">-->
          <!--    </div>-->
          <!--    <div class="service-footer">-->
          <!--      <a href="../error/Under Development.php" class="service-btn">-->
          <!--          Queueing-->
          ...
          <div class="col-lg-6 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-card primary-care">
              ...
              <div class="service-footer">
                <a href="queue.php" class="service-btn">
                    Queueing
                    <i class="fas fa-arrow-right"></i>
                  </a>
              </div>
        ...
        <!-- Transmittal -->
          <!--<div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-de lay="200">-->
          <!--  <div class="service-card primary-care">-->
          <!--    <div class="service-header">-->
          <!--      <div class="service-icon">-->
          <!--        <i class="fas fa-heartbeat"></i>-->
          <!--      </div>-->
          <!--      <span class="service-category">Queue Display</span>-->
          <!--    </div>-->
          <!--    <div class="service-body">-->
          <!--    </div>-->
          <!--    <div class="service-footer">-->

        ...
        <!-- User Management -->
          <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            ...
            <div class="service-header">
              ...
              <span class="service-category">Users</span>
            </div>
              <div class="service-body">
              </div>
              <div class="service-footer">
                <a href="../list/users.php" class="service-btn">
                  User Management <i class="fas fa-arrow-right"></i>
                </a>
              </div>
            </div>
          </div>
        ...
        <!-- Prescription -->
          <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-card primary-care">
              ...
              <div class="service-footer">
                <a href="prescription.php" class="service-btn">
                    Prescription List
          ...
          <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-card primary-care">
              <div class="service-header">
                ...
                <span class="service-category">Settings</span>
              </div>
              <div class="service-body">
              </div>
              <div class="service-footer">
                <a href="settings.php" class="service-btn">
                      Settings
                    <i class="fas fa-arrow-right"></i>
                  </a>
              </div>

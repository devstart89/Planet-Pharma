    ...
    <div class="page-title">
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            <?php if (isset($_SESSION['user'])): ?>
                <li><a class="btn-getstarted" href="logout.php">Back to Dashboard</a></li>
            <?php else: ?>
                <li><a class="btn-getstarted" href="login.php">Home</a></li>
            <?php endif; ?>
            ...
            <div class="col-lg-6">
              <div class="content-wrapper">
                ...
                <div class="action-buttons">
                  <a href="login.php" class=" secondary-link">Request E-Prescription</a>
